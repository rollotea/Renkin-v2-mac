...
export function FileManagerTableRow({
  ...
  const confirmOutputDialog = useBoolean();
  ...
  const renderMenuActions = () => (
    ...
    >
      <MenuList>
        ...
        <MenuItem
          onClick={() => {
            confirmOutputDialog.onTrue();
            menuActions.onClose();
          }}
          sx={{ color: "grey.600" }}
        >
          <Iconify icon="solar:download-broken" />
          Output
        </MenuItem>
  ...
  const renderConfirmOutputDialog = () => (
    <ConfirmDialog
      open={confirmOutputDialog.value}
      onClose={confirmOutputDialog.onFalse}
      title="Output"
      content="Are you sure want to output?"
      action={
        <Button
          variant="contained"
          color="primary"
          onClick={() => {
            confirmOutputDialog.onFalse();
            onOutputRow();
          }}
        >
          Output
