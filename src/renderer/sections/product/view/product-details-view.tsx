  ...
  return (
    <DashboardContent>
      <ProductDetailsToolbar
        ...
        liveHref={paths.dashboard.product.details(`${product?.id}`)}
      ...
      >
        ...
        <Card>
          <CardHeader title="Forbidden String" />

          <Stack spacing={2} sx={{ p: 3, typography: "body2" }}>
            {/* <Box>{info.quote}</Box> */}
            {product?.filter.ForbiddenStrings.map((data) => (
              <Box sx={{ display: "flex" }}>
        ...
        <Card>
          <CardHeader title="Replacement String" />
          <Stack spacing={2} sx={{ p: 3, typography: "body2" }}>
            {/* <Box>{info.quote}</Box> */}
            {product?.filter.ReplacementPairs.map((data) => (
              <Box sx={{ display: "flex" }}>
