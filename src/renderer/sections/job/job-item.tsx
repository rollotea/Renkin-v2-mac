...
export function ScrapingTemplateItem({
  scrapingTemplate,
  editHref,
  detailsHref,
  onDelete,
      ...
      <Card sx={sx} {...other}>
        ...
        >
          {[
            ...
            {
              label: scrapingTemplate.anonymousDelivery
                ? "Anonymous"
                : "Not Anonymous",
            ...
            {
              label: scrapingTemplate.category,
              icon: (
                <Iconify
                  width={16}
