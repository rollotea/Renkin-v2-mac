...
import { fetchAllForbiddenString } from "../api/fetch-data";
...
const TABLE_HEAD: TableHeadCellProps[] = [
  ...
  { id: "name", label: "Forbidden String" },
...
export function OrderListView() {
  ...
  const [tableData, setTableData] = useState<ForbiddenStringRow[]>([]);
  useEffect(() => {
  ...
  const handleDeleteRow = useCallback(
    async (id: string) => {
      try {
        const promise = window.electron.ipcRenderer.deleteForbiddenString(id);
  ...
  const handleDeleteRows = useCallback(async () => {
    try {
      const promise = window.electron.ipcRenderer.deleteForbiddenStrings(
        table.selected
      );
      toast.promise(promise, {
        loading: "Loading...",
    ...
    <>
      <DashboardContent>
        ...
        <Card>
          ...
          <OrderTableToolbar
            fetchAllForbiddenString={fetchAllForbiddenString}
